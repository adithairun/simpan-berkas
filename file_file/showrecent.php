 ...
 *
 *   $Id: showrecent.php, v1.25 04/11/2018 21:08 Flava Clown $
 *
 *
 ***************************************************************************/
...
function is_new($current_dir)
{
	...
	while (false !== ($filename = readdir($handle)))
    {
	    ...
	    if (!preg_match($reserved_files, $filename) && show_hidden_files($filename))
		{
    ...
    <tr bgcolor=\"$tablecolor\" valign=\"top\">";
      ...
      <td align=\"left\" width=\"95%\" valign=\"middle\" nowrap>
        <font size=\"1\" color=\"$normalfontcolor\" face=\"$font\">\n";
			...
			$today = time() - $timeoffset * 3600;
			if (date('Y-m-d',$file_modif_time) != date('Y-m-d',$today))
