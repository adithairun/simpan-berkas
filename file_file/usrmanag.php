 ...
 *   copyright            : ('C) 2010-2018 phpATM Dev Team
 *   email                : flavaclown.de/contact.php
 *
 *   $Id: usrmanag.php, v1.08 04/11/2018 21:36 Flava Clown $
 *
 *
 ***************************************************************************/
...
function print_user_profile()
{
  ...
  <table cellSpacing=\"1\" cellPadding=\"4\" width=\"90%\" bgColor=\"$bordercolor\" border=\"0\">
	...
	$shownaccounts = 0;
	$currentaccount = 0;
	foreach($users as $filename => $filed)
	{
		$currentaccount++;
		if ($usercount > $accountsperpage)
		{
   ...
   <table border=\"0\" width=\"90%\" bgcolor=\"$bordercolor\" cellpadding=\"4\" cellspacing=\"1\">
     ...
     <tr>
		...
		echo "  </select>
			 ...
			 <tr>
               <td align=\"left\" width=\"30%\"><font size=\"1\" face=\"$font\" color=\"$normalfontcolor\">$mess[83]</font></td>
               <td align=\"left\" width=\"70%\"><font size=\"1\" face=\"$font\" color=\"$normalfontcolor\">
                 <input type=\"password\" class=\"vform\" name=\"password\">
               </font></td>
             </tr>
              <tr>
